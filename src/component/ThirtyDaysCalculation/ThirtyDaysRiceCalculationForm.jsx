...
import ThirtyDaysRiceCalculationTable from './ThirtyDaysRiceCalculationTable';
...
const ThirtyDaysRiceCalculationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoader(true);
      await totalRiceOneBorderApi(payload);
      setShow(true);
    } catch (error) {
...
export default ThirtyDaysRiceCalculationForm
