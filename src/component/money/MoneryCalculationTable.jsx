...
const MoneyCalculationTable = ({ borderMoneyDataList, totalMoneyCalculation,  }) => {
                ...
                <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
                    ...
                    <div  style={{ maxWidth: '800px' }}>
                        <table className="min-w-full bg-white border border-gray-300">
                            ...
                            <tbody>
                                {borderMoneyDataList && borderMoneyDataList.map((item, i) => (
                                    <tr key={i} className="hover:bg-gray-100 text-center">
                                        ...
                                        <td className="py-2 px-4 border-b border-gray-300">{item?.totalMoney || 0} টাকা</td>
                                        <td className="py-2 px-4 border-b border-gray-300">
                        ...
                        <div className="mt-4 gap-10">
                            {totalMoneyCalculation !== undefined && <p>মোট টাকা দিচ্ছেন : {totalMoneyCalculation} টাকা</p>}
                            
                            <p className="text-end">হিসাবের তারিখ : {moment().format('MMMM Do YYYY')}</p>
...
export default MoneyCalculationTable;
