...
import MoneryCalculationTable from './MoneryCalculationTable';
import moneyStore from '../../api-request/moneyApi';

const MoneyCalculationForm = () => {
  const { borderNameApi, borderNameList } = borderStore();
  const { totalMoneyCalculationApi, borderMoneyDataList, totalMoneyCalculation } = moneyStore();
...
export default MoneyCalculationForm;
